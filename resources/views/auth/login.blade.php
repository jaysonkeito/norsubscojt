...
@section('welcome_panel')
    <div class="welcome-inner">
        ...
        <h2>Welcome Back!</h2>
        <p>Sign in to continue tracking your OJT hours, requirements, and progress.</p>
        <p class="welcome-cta-hint mb-1">Don't have an account?</p>
        <a href="{{ route('register') }}" class="btn-welcome-cta">Sign Up <i class="bi bi-arrow-right"></i></a>
    </div>
@endsection
    ...
    <form method="POST" action="{{ route('login') }}" autocomplete="off">
        ...
        <div class="mb-2">
            ...
            <div class="password-input-group">
                <input type="password" name="password" id="loginPassword" class="form-control" placeholder="Enter your password" required autocomplete="current-password" oninput="toggleEyeVisibility('loginPassword', 'loginEyeBtn')">
