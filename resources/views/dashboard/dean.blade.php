...
@section('content')
<h3 class="mb-4">Dean Dashboard</h3>
<div class="row g-3 mb-4">
    ...
    <div class="col-6 col-md-3">
        <a href="{{ route('companies.index') }}" class="text-decoration-none text-reset">
            <div class="card p-3">
    ...
    <div class="col-6 col-md-3">
        <a href="{{ route('coordinators.index') }}" class="text-decoration-none text-reset">
            <div class="card p-3">
    ...
    <div class="col-6 col-md-3">
        <a href="{{ route('pending-approvals.index') }}" class="text-decoration-none text-reset">
            <div class="card p-3">
                <small class="text-muted">Pending Your Approval</small>
                <h3 class="{{ $pendingApprovals > 0 ? 'text-danger' : '' }}">{{ $pendingApprovals }}</h3>
            </div>
        </a>
    </div>
</div>
